...
Writing this blog post was an interesting experience and helped me to sharpen my own understanding
how Rust internally works and what I actually learned about it over the course of this project.
...
required features are still missing and especially something is missing to bring e.g. a clock into
the panel, but I am eagerly looking at {extism}[Extism] for this matter.
