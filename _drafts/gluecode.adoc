...
via a [REST][] endpoint and allows the creation of todo entries.

So our first use case is the creation of todo entries based on a given `title` and a `description`:
