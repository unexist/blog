...
The general idea of [behavior-driven design][] is to define and later verify the behavior of a
software component without further knowledge of the technology and internal workings behind it.

This is also called a **blackbox test** - in contrast to **whitebox tests**, that explicitly
