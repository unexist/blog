...
service in [Entity Data Model][] (or EDM respectively EDMX if you insist on [XML][]).

This model contains following basic types:
...
The output can be pretty long, but here is a sample of the Todo entity in a few dozen
lines of [JSON][]:
