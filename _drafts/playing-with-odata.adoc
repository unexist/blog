...
service and interact with it in a [CRUD][] manner.
...
won't rely on something like [olingo-jpa-processor-v4][].

Still, implementing Olingo was quite funny and a perfect target for [TDD][] due to the
