...
And although [JSON][] is a really poor choice for a letter exchange, it is quite common in-between
services:
...
At this point nothing stops us from building a mapping layer, but please put that thought aside and
let me point you to version.

This should be the obvious solution to our problem, but version what exactly - the endpoint itself
or rather our message?
