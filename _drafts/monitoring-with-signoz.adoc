...
The last pillar is one of the most interesting and troublesome, since there is no easy
recipe what could and what should be done.
...
There is also a way to fallback to [Power Automate][], unfortunately this requires another subscription.
