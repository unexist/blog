...
If you did go the Podman way, installing it is quite easy otherwise please consult the really good
[quickstart guide][].
...
<4> Write the stream back to a file of the catalog continuously
