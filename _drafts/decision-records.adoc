...
The index page accumulates all known records, groups them based on different properties like
the severity and combines everything into a single and clickable page.

NOTE: Generating the index page requires a populated database, due to the heavy usage of the tools.
