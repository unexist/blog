...
There have been several iterations of tackling the overall complexity of the data storage.
The first approach was just put everything into vast SQL-databases and keep the data in so-called
[Data Warehouses].
...
- No data schema is enforced on write and everything is a flat-file
