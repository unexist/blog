...
address modern expecations of fault-tolerance and obviously the latency of the systems.

This can be easy for smaller scales, but causes lots of headaches for petabytes of data.
of data.
Unfortunately the storage size is only one-half of the problem, processing large quantities of data
also drastically increases the processing time.
