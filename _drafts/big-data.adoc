...
Due to its smaller storage footprint, [Musl][] is a good candidate for containerization and the
default libc chosen there.
...
One of the drawbacks of using software in a **rolling-update-way** is that you stumble upon nasty
