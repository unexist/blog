...
address modern concerns for to fault-tolerance and obviously the latency of the systems.
This can be easy for smaller scales, but can cause lots of headaches if you want to store petabytes
of data.
