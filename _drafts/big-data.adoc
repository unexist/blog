...
Some of these containers actually [line-through]#worked# started, but I knew I had to ultimately roll my own to understand
the intricate design and communication between all the moving parts.
...
Big data is the story of a simple idea to keep every bit until it might become useful later and
the related problems that come along with it.
