...
I won't bore you with a fancy definition about what data actual is, although there are some funny
quotes about it:

[quote, "Jim Barksdale (former Netscape CEO)"]
"If we have data, let’s look at data. If all we have our opinions, let’s go with mine."

So instead, let us talk about the actual problems Big Data tries to address, how this is done and
what the actual drawbacks of it are.
