...
and [Github][]'s [Copilot][], due to its access to the vast amount of _free_ training data, their
promise of [code synthesis][] and obviously the inclusion of my own repositories accordingly to my
settings:
