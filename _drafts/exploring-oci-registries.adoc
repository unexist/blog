...
logins.
Apart from defaults we also want to enable the fancy {zotregweb}[web ui] and the {cve}[CVE]
...
Once the registry fetched the CVE database and is up running we are greeted with
