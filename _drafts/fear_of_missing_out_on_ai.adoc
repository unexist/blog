...
:coredomain: https://ddd-practitioners.com/home/glossary/domain/core-domain/
...
Another issue I see with increasing productivity is the orientation towards throughpput or rather
...
and the exploitation of people in fabric factories and according to media the same is true for
the AI industry.
...
I am working in the software industry and I always had an ambivalent opinion towards
{saas}[Software-as-a-Service], but I am also a strong proponent of staying at your
{coredomain}[core domain] and hand-off supporting ones, so I am a bit at a tie.
