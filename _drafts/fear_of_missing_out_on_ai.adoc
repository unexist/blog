...
:useaiorlose: https://kagi.com/search?q=use+ai+or+lose+our+edge
...
Oftentimes these posts appear to be written with the help of AI and especially {spotai}}[em-dashes enjoy
...
Here we can start with something positive:
...
is an original {hallucinationasfeat}[feature of LLM design], but I think we
