...
[Apache Spark][] is probably one of the the strongest contender and provides a unique approach
to the whole idea.
...
Its key driving goal is to provide an unified platform for writing Big Data applications and
