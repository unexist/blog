...
Welcome to round three of our journey through the mysterious world of [Big Data][].
...
Its key driving goal is to provide an unified platform for writing Big Data applications.
