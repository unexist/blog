...
<3> Dataframes are mainly simple data structures and can be easily used to create the [view][] **todo**
<4> Once created the view can be accessed like any normal view with SQL
<5> Evaluations of dataframes are lazy and evaluated only when required
