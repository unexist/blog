...
audience later.
And afterwards the resulting documentation is stowed away in rare places like a company fileshare for
various document types of the [Office][]-family or sometimes even worse in an semi-unstructured
company [Confluence][].
