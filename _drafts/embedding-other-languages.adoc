...
It took me quite some time figuring out how to restore the missing parts and thankfully found them
in a backup.
Additionally, there has never been a real usage of the project on my side, _but_ I can show off
