...
I abide of throwing {obj-c}[Obj-c] into this mix here, but I can show off a a test script of the
API, since I again have no real screenshots and lack the required hardware to give it a spin:

.{touchjs}[touchjks]/test/wm.js:1
[source,javascript]
----
/* WM */
var wm = new TjsWM(); // <.>
...
I ultimately got rid of macOS and made the decision this is all for naught and
