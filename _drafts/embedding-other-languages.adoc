...
Adding {obj-c}[Obj-C] to this blog is probably something for another day, _but_ I can show off a
test script of the API along with some scree since I again have no real screenshots and lack the required hardware to
give it a spin:
