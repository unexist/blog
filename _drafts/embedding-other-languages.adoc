...
Among it, there are some boring and pretty self-explanatory ones like
...
How a certain quality is best achieved depends on a plethora of things, but one way to archive
extensibility, according to {Wikipedia}[Wikipedia], is to use scripting languages and they can
be quite embeddable.

So please be my guest on my lenghty journey through 20+ years of personal {FOSS}[FOSS]-history and
listen to an old man laying out different approaches of embedding scripting languages and why this
