...
Adding {obj-c}[Obj-c] to this blog is probably something for another day, but I can show off a
test script of the API, since I again have no real screenshots and lack the required hardware to
give it a spin:
