...
check we settle for any of the mature CSV-parser our programming language provides.
And once wired up and deployed, our solutions works splendidly, until a change is necessary.

So far there weren't citation of old Greeks in this blog - about time to change that:
