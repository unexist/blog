...
Jobs are provided as simple jar files and
...
$ hadoop fs -put tododata.json input/

$ hadoop jar todo-mapreduce-0.1.jar com.sodonnel.MapReduce.WordCount input output
----

The submission flow can be simplified like this:
