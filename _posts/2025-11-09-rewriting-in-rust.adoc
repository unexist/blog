...
description: This blog post describes my experience and learnings during the port of my pet window manager project subtle from C to Rust.
date: 2025-11-09 17:32 +0100
last_updated: 2025-11-09 17:32 +0100
...
{{ site.url }}{% post_url 2025-09-22-fear-of-missing-out-on-ai %}[previous blog post], but to have
...
solution to a problem, which is still relevant today.
...
----
<.> {derive}[Derive] is one of Rust's real work horses.
...
Maybe I should have read {cleancode}[Clean Code] some years earlier <<cleancode>>..
